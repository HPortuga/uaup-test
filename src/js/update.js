...
const updateOptions = {
    ...
    appName: "uaup-test", //[Required] The Name of the app archive and the app folder.
    appExecutableName: "uaup-test.exe", //[Required] The Executable of the Application to be Run after updating.
